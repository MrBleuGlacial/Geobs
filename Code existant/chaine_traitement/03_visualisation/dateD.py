...
# emplacement des fichiers CSV de la base (ex. : ['//home//julie//csv//creation1.csv','//home//julie//csv//creation2.csv']
# les 2 listes (dates de création et publication) doivent contenir le même nombre d'éléments
...
# la liste doit contenir le même nombre d'éléments que liste_csv_crea et liste_csv_publi
liste_label = ['pigma']
# couleur du graph (ex. : ['Cyan',Red']) (noms HTML par ex.) ('Cyan', 'Blue', 'Red, 'DarkRed', LawnGreen', 'DarkGreen')
# les 2 listes doivent contenir le même nombre d'éléments que liste_csv_crea et liste_csv_publi
