...
# emplacement des fichiers CSV de la base (ex. : ['//home//julie//csv//categ1.csv','//home//julie//csv//categ2.csv']
# la liste peut contenir 1 fichier ou +
liste_csv = ['//home//julie//Bureau//csv//categories.csv']
# etiquettes (ex. : ['pigma','geopal']
# la liste doit contenir le meme nombre d'elements que liste_csv
liste_label = ['pigma']
# couleurs des barres (ex. : ['b','g']) ('b' pour bleu, 'r' pour rouge, 'g' pour vert) 
# la liste doit contenir le meme nombre d'elements que liste_csv
liste_couleur = ['b']
# csv selon lequel trier les catégories (1 pour le 1er de liste_csv, etc.)
tri = '1'
# fichier log tenant compte du nb de fiches avec 0, 1, 2, etc. catégories remplies (ex. : '//home//julie//csv//log_categ.csv')
